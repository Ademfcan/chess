...
public class PGNTests {
    ...
    @Test void pgnConsistencyTest(){
        ...
        System.out.println(normalizeString(thirdPgn));
        System.out.println(normalizeString(pgnOut2));
        System.out.println(findDifferenceBetweenStrings(normalizeString(thirdPgn),normalizeString(pgnOut2)));
        Assertions.assertEquals(normalizeString(thirdPgn),normalizeString(pgnOut2));
        String fourthPgn = "1.e4 d5 2.Nf3 dxe4 3.Nd4 e3 4.fxe3 e5 5.Nb3 Bb4 6.c3 Nf6 7.cxb4 Bg4 8." + "Be2 Bxe2 9.Qxe2 Ne4 10.O-O O-O 11.d3 Nc5 12.bxc5 c6 13.d4 Nd7 14.dxe5 Nxe5 " +
    ...
    @Test void largerCreationTest(){
        final String[] top50Openings = {
