...
public class ChessPosition {
    ...
    public List<BackendChessPosition> getAllChildPositions(boolean isWhite, ChessStates gameState) {
        ...
        childPositionsPriority1.sort((a, b) -> {
            double attackerValueA = ChessConstants.valueMap[a.getMoveThatCreatedThis().getBoardIndex()];
            double victimValueA = ChessConstants.valueMap[a.getMoveThatCreatedThis().getEatingIndex()];

            double attackerValueB = ChessConstants.valueMap[b.getMoveThatCreatedThis().getBoardIndex()];
            double victimValueB = ChessConstants.valueMap[b.getMoveThatCreatedThis().getEatingIndex()];
