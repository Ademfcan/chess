...
public class CampaignManager {
    ...
    private StackPane levelContainer;
    private Pane levelContainerElements;
    private Pane levelContainerPath;
    private ScrollPane campaignScroller;
    ...
    public CampaignManager(StackPane levelContainer, Pane levelContainerElements, Pane levelContainerPath, ScrollPane campaignScroller,StackPane mainArea,ImageView campaignBackground,ImageView campaignBackground2){
        ...
        System.out.println(Arrays.toString(cloudYBindings));
...
//            System.out.println(campaignScroller.getVvalue());
    ...
    private CampaignTier getCurrentTierScrollerIsOn(double currentVvalue){
        ...
        System.out.println("Should not be here(get current tier scroller is on)");
        System.out.println(Arrays.toString(vvaluesForTiers));
...
//        System.out.println("Numtiers: " + curTier + " numclouds: " + curCloudOrdinal);
        ...
        if(onlyCloud){
            ...
            // slight offset
            total = total.add(levelContainerPath.widthProperty().multiply(0.3));
        }
    ...
    private String unfilledUrl = "/ChessAssets/StartScreenPawn/pawnUnfilled.png";
    private String filledUrl = "/ChessAssets/StartScreenPawn/pawnFilled.png";
    private Image unfilledPawn = new Image(unfilledUrl);
    private Image filledPawn = new Image(filledUrl);
    public void setLevelUnlocksBasedOnProgress(CampaignProgress playerProgress){
        for(int i = CampaignTier.LastTier.ordinal();i>=0;i--){
            ...
            int lockedAmnt =-1;
            int unlockedAmnt =-1;
            if(playerProgress.getCurrentTier().equals(curTier)){
            ...
            while (unlockedAmnt > 0){
                ...
                System.out.println("Pawn progress: " + pawnLevel);
    ...
    private List<VBox[]> infoContainers;
    private List<DoubleBinding[]> yLayoutBindings;
