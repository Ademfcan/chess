...
//    private Client simulatedClient;
...
//        this.currentGame = ChessGame.getOnlinePreInit(gametype.getStrVersion(), PlayerInfo.defaultInfo);
//
...
//        UserInfo fakeUser = UserInfo.getPartiallyDefaultUserInfo("a", "a", UUID.fromString("a"));
//
...
//
//        return new Client(fakeUser);
//    }
//
//    public void enteringGame(boolean isPlayer1White) {
//        currentGame.updateInfoFromPartialInit(PlayerInfo.defaultInfo, isPlayer1White);
//    }
//
