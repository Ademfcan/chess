...
public class chessFunctions {
    ...
    public static boolean[] checkIfContains(int x, int y, long[] whitePieces, long[] blackPieces){
    ...
    public static boolean checkIfContains(int x, int y, boolean isWhite, long[] whitePieces, long[] blackPieces){
        long board  = positionToBitboard(x,y);
        if(isWhite){
            for(long l : whitePieces){
                long sum = board & l;
    ...
    public static int getBoardWithPiece(int x, int y, boolean isWhite, long[] whitePieces, long[] blackPieces){
        long bitIndex = chessFunctions.positionToBitboard(x,y);
        if(isWhite){
